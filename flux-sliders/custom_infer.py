...
def run_inference(
    ...
    img_filename = f"no_lora_seed_{seed}.jpg"
    image.images[0].save(os.path.join(output_dir, img_filename), "JPEG")
    ...
    for net in networks:
        for scale in scales:
            ...
            img_filename = f"slider_{net}_seed_{seed}_scale_{scale}.jpg"
            image.images[0].save(os.path.join(output_dir, img_filename), "JPEG")
